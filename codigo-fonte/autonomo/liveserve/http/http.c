...
static void *responsehttp(void *arg){
    return NULL;
}
...
static void *conectionHttp(void *arg)
{
    ...
    char *resposta = NULL;
    if(strstr(buffer, "GET /") != NULL && strstr(buffer, ".js") != NULL) resposta = ler_arquivo("script.js","text/javascript");
    else if(strstr(buffer, "GET /") && strstr(buffer, ".css") != NULL) resposta = ler_arquivo("style.css","text/css");
    else if(strstr(buffer, "GET / ") != NULL) resposta = ler_arquivo("index.html","text/html");
    if(resposta != NULL)
    {
